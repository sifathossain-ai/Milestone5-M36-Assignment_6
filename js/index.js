        ...
        div.innerHTML = `
            <div class="card border rounded-md px-2 py-2 md:px-4 md:py-4">
                ...
                <div class = "flex justify-between mt-3 gap-2">
                    ...
                    <button onclick = "addToLiked('${product.image}')" class="btn btn-outline border px-3 md:px-4 lg:px-5 text-primaryColor font-bold border-primaryColor border-opacity-10"><i class="fa-solid fa-thumbs-up"></i></button>

                    <button onclick = "showConModal()" class="btn btn-outline border px-2.5 md:px-3 lg:px-4 text-primaryColor font-bold border-primaryColor border-opacity-10">Adopt</button>

                    <button id="details-btn" onclick = "petDetails(${product.petId})" class="btn btn-outline border px-2.5 md:px-3 lg:px-4 text-primaryColor font-bold border-primaryColor border-opacity-10">Details</button>
                </div>
            </div>
        `
